...
class AttarUI:
    def __init__(self, face_path, size=None):
        self.root = tk.Tk()
        self.root.title("A.T.T.A.R — ASIF AI")
        ...
        self._attar_state = "INITIALISING"
    ...
    def _draw(self):
        ...
        c.create_text(W // 2, 44, text="Artificial Technical Tracking And Reasoning",
        ...
        if self.muted:
            ...
            stat = "● SPEAKING"
            sc   = C_ACC
        elif self._attar_state == "THINKING":
            sym  = "◈" if self.status_blink else "◇"
            stat = f"{sym} THINKING"
            sc   = C_ACC2
        elif self._attar_state == "PROCESSING":
            sym  = "▷" if self.status_blink else "▶"
            stat = f"{sym} PROCESSING"
            sc   = C_ACC2
        elif self._attar_state == "LISTENING":
            sym  = "●" if self.status_blink else "○"
        ...
        c.create_text(W // 2, H - 14, fill=C_DIM, font=("Courier", 8),
                      text="Attar Asif Industries  ·  CLASSIFIED  ·  ASIF AI")
    ...
    def write_log(self, text: str):
        ...
        elif tl.startswith("attar:") or tl.startswith("ai:"):
    ...
    def _show_setup_ui(self):
        ...
        tk.Label(self.setup_frame,
                 text="Enter your Gemini API key to boot A.T.T.A.R.",
    ...
    def _save_api_keys(self):
        ...
        self.set_state("LISTENING")
        self.write_log("SYS: Systems initialised. ATTAR online.")
