"""
memory_manager.py — ASIF AI Hafıza Sistemi
============================================
Düzeltmeler:
...
def should_extract_memory(user_text: str, attar_text: str, api_key: str) -> bool:
    """
    ...
    try:
        ...
        # Her iki tarafı da gönder — Attar'in söyledikleri de bilgi içerebilir
        combined = f"User: {user_text[:300]}\nAttar: {attar_text[:200]}"
...
def extract_memory(user_text: str, attar_text: str, api_key: str) -> dict:
    """
    ...
    try:
        ...
        raw = model.generate_content(
            ...
            f"                  (e.g. asif_ai: 'Building a ATTAR-like AI assistant')\n"
            ...
            f"- Extract from BOTH user and Attar turns.\n"
            ...
            f' "projects":{{"asif_ai":{{"value":"ATTAR-like AI assistant on Windows"}}}},\n'
